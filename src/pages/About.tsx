...
const About: React.FC = () => {
    ...
    return (
        <div className="bg-black min-h-screen text-white selection:bg-white selection:text-black">
                ...
                <div className="flex flex-col md:flex-row items-center gap-20">
                    ...
                    <div className="w-full md:w-6/12 space-y-8 reveal transition-delay-200">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif leading-[1.1] tracking-tight">
                            Silent observer <br />
                            of the <span className="italic text-white/40">fleeting</span> moment.
                        </h1>
                        <p className="text-gray-400 font-light leading-relaxed max-w-xl text-base md:text-lg lg:text-xl">
            ...
            <section className="py-48 px-8 md:px-16 border-t border-white/5">
                <div className="max-w-[1800px] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-32">
                        <div className="reveal">
                            <span className="text-xs tracking-[0.4em] uppercase text-gray-500 block mb-12">Direction Artistique</span>
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif leading-tight mb-12">
                                Stripping away the <br /> superfluous.
                            </h2>
                        </div>
                        <div className="space-y-16 reveal transition-delay-200">
                            <div className="space-y-6">
                                <h3 className="text-xl md:text-2xl font-serif">Visual Identity</h3>
                                <p className="text-gray-400 font-light leading-relaxed text-base md:text-lg lg:text-xl">
                            ...
                            <div className="space-y-6">
                                <h3 className="text-xl md:text-2xl font-serif">Consistency</h3>
                                <p className="text-gray-400 font-light leading-relaxed text-base md:text-lg lg:text-xl">
            ...
            <section className="py-32 px-8 md:px-16 bg-white/5">
                <div className="max-w-[1800px] mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-start mb-24 reveal">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif">Selected <br /> Collaborations</h2>
                        <p className="text-gray-400 mt-8 md:mt-0 max-w-md font-light text-base md:text-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 reveal transition-delay-200">
                        <div className="space-y-8">
                            ...
                            <ul className="space-y-4 font-serif text-lg md:text-xl lg:text-2xl text-gray-300">
            ...
            <section className="py-32 px-8 md:px-16">
                <div className="max-w-4xl mx-auto text-center reveal">
                    ...
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif leading-tight mb-12">
            ...
            <div className="py-32 flex justify-center border-t border-white/5 reveal">
                <Link to="/contact" className="group flex flex-col items-center space-y-10">
                    ...
                    <span className="text-2xl md:text-3xl lg:text-4xl font-serif group-hover:text-white/80 transition-colors uppercase tracking-widest font-light">Start a Project</span>
                </Link>
            </div>
